...
exports.parseEventFromText = void 0;
...
exports.parseEventFromText = functions
    .region('us-central1')
    .https
    ...
    try {
        ...
        if ((usage.count || 0) >= dailyLimit) {
            throw new functions.https.HttpsError('resource-exhausted', `Napi limit túllépve (${dailyLimit} hívás/nap). Próbáld újra holnap.`);
        }
...
A JSON Schema szerint add vissza az adatokat.`;
            ...
            for (let attempt = 0; attempt < maxRetriesPerModel; attempt++) {
                try {
                    ...
                    if (!response.ok) {
                        ...
                        const error = new Error(`Gemini API error: ${response.status} - ${JSON.stringify(responseData)}`);
                    ...
                    if ((_f = (_e = (_d = (_c = (_b = responseData.candidates) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.content) === null || _d === void 0 ? void 0 : _d.parts) === null || _e === void 0 ? void 0 : _e[0]) === null || _f === void 0 ? void 0 : _f.text) {
                    ...
                    console.log('Content length:', (jsonContent === null || jsonContent === void 0 ? void 0 : jsonContent.length) || 0);
                    ...
                    console.error(`Gemini API error - Model: ${model} (attempt ${attempt + 1}/${maxRetriesPerModel}):`, {
                        ...
                        status: error.status || error.statusCode || ((_g = error.response) === null || _g === void 0 ? void 0 : _g.status),
                        code: error.code,
                        stack: (_h = error.stack) === null || _h === void 0 ? void 0 : _h.substring(0, 500)
                    });
                    // Ellenőrizzük a hiba típusát
                    const errorStatus = error.status || error.statusCode || ((_j = error.response) === null || _j === void 0 ? void 0 : _j.status) || 0;
        ...
        const validatedEvent = {
            ...
            visibility: eventJson.visibility || 'family',
            assignedTo: eventJson.assignedTo || null,
            points: eventJson.points || 10,
...
//# sourceMappingURL=parseEventFromText.js.map