...
exports.createEvent = functions
    ...
    try {
        ...
        const projectId = process.env.GCLOUD_PROJECT || ((_b = functions.config().project) === null || _b === void 0 ? void 0 : _b.id) || 'familyweekroutine';
        ...
        const eventData = {
            ...
            exceptions: [],
            reminders: {
                enabled: ((_c = event.reminders) === null || _c === void 0 ? void 0 : _c.enabled) !== undefined ? event.reminders.enabled : true,
                times: ((_d = event.reminders) === null || _d === void 0 ? void 0 : _d.times) || [10, 30],
                sound: ((_e = event.reminders) === null || _e === void 0 ? void 0 : _e.sound) !== undefined ? event.reminders.sound : true,
                vibration: ((_f = event.reminders) === null || _f === void 0 ? void 0 : _f.vibration) !== undefined ? event.reminders.vibration : true
            },
            notificationRecipients: ((_g = event.reminders) === null || _g === void 0 ? void 0 : _g.enabled) ? (event.notificationRecipients || [userId]) : [],
            createdBy: userId,
