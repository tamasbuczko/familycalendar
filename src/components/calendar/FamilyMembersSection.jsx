        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-6 w-full max-w-2xl mx-auto">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex space-x-2">
                    <button
                        onClick={onAddMember}
                        className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-300 ease-in-out transform hover:scale-105"
                    >
                        <i className="fas fa-plus mr-2"></i>Családtag hozzáadása
                    </button>
                    <button
                        onClick={onInviteMember}
                        className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-300 ease-in-out transform hover:scale-105"
                    >
                        <i className="fas fa-envelope mr-2"></i>Meghívás
                    </button>
                    <button
                        onClick={() => {
                        ...
                        className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition duration-300 ease-in-out transform hover:scale-105"
                    >
                        <i className="fas fa-baby mr-2"></i>Gyerek profil
                    </button>
                </div>
            </div>
